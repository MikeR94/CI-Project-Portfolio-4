...
urlpatterns = [
    ...
    path("staff/reset-review/<review_id>", views.staff_reset_review, name="staff_reset_review"),
    ...
    path("staff/no-show/<booking_id>", views.staff_no_show, name="staff_no_show"),
    ...
    path("staff/details-booking/cancel/<booking_id>", views.staff_cancel_booking, name="staff_cancel_booking"),
]