...
class PaymentForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if amount_paid < amount_owed:
            self._errors['amount_paid'] = self.error_class(['This bill has not been settled. Please settle this bill before submitting payment information'])
            self._errors['amount_owed'] = self.error_class(['This bill has not been settled. Please settle this bill before submitting payment information'])
